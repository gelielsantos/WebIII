...
public class Controller007 {
	...
	@GetMapping("/{name}")
	public Model007 findOne(@PathVariable String name) {
		return service007.findOne(name);
	}
	
	@PostMapping
	public Map<String, String> insert(@RequestBody Model007 model007){
		return service007.insert(model007);
	}
	
	@PutMapping
	public Map<String,String> edit(@RequestBody Model007 model007){
